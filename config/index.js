...
const config = {
  ...
  ROUTERS: {
    pancakeswap_v2: process.env.PCS_V2_ROUTER,
    pancakeswap_v3: process.env.PCS_V3_ROUTER,
  ...
  EXTERNAL: {
    dexscreener: process.env.DEXSCREENER_URL,
    geckoTerminal: process.env.GECKO_TERMINAL_URL,
  },
